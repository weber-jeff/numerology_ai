# astro_meanings.py - Store basic astrological meanings and definitions
...
house_meanings = {
    1: {
        ...
        "traits": ["Independent", "Assertive"],
        "strengths": ["Courage", "Initiative"],
        "weaknesses": ["Impulsiveness", "Self-centeredness"],
        "advice": "Consider others' needs before acting.",
        "business": "Entrepreneurship, personal branding.",
        "relationships": "Attracts partners who admire independence.",
        "purpose": "To assert individuality and initiate new beginnings."
    },
    2: {
        "name": "Second House",
        ...
        "traits": ["Practical", "Resourceful"],
        "strengths": ["Financial acumen", "Material security"],
        "weaknesses": ["Materialistic", "Greedy"],
        "advice": "Focus on self-worth, not just net worth.",
        "business": "Finance, real estate, personal investments.",
        "relationships": "Values partners who provide stability.",
        "purpose": "To build a secure foundation and understand personal value."
    },
    3: {
        "name": "Third House",
        ...
        "traits": ["Communicative", "Curious"],
        "strengths": ["Expressiveness", "Adaptability"],
        "weaknesses": ["Gossip", "Restlessness"],
        "advice": "Listen as much as you speak.",
        "business": "Writing, teaching, journalism, sales.",
        "relationships": "Seeks partners who are intellectually stimulating.",
        "purpose": "To share information and connect with the immediate environment."
    },
    4: {
        ...
        "weaknesses": ["Clinginess", "Over-sensitivity"],
        "advice": "Create healthy boundaries with family.",
        "business": "Real estate, interior design, family businesses.",
        "relationships": "Values partners who provide emotional security.",
        "purpose": "To establish a secure emotional foundation and honor roots."
    },
    5: {
        "name": "Fifth House",
        ...
        "strengths": ["Expressiveness", "Enthusiasm"],
        "weaknesses": ["Self-indulgence", "Drama"],
        "advice": "Channel creativity productively.",
        "business": "Arts, entertainment, teaching, childcare.",
        "relationships": "Attracts partners who appreciate creativity and fun.",
        "purpose": "To express individuality and experience joy."
    },
    6: {
        "name": "Sixth House",
        ...
        "traits": ["Diligent", "Helpful"],
        "strengths": ["Organization", "Attention to detail"],
        "weaknesses": ["Perfectionism", "Worry"],
        "advice": "Prioritize self-care to avoid burnout.",
        "business": "Healthcare, administration, service industries.",
        "relationships": "Seeks partners who value health and routine.",
        "purpose": "To improve daily life through service and attention to detail."
    },
    7: {
        ...
        "strengths": ["Fairness", "Negotiation"],
        "weaknesses": ["Codependency", "Compromise"],
        "advice": "Maintain individuality within partnerships.",
        "business": "Law, consulting, sales, mediation.",
        "relationships": "Values partners who are fair and balanced.",
        "purpose": "To achieve balance and growth through partnerships."
    },
    8: {
        "name": "Eighth House",
        ...
        "traits": ["Intense", "Mysterious"],
        "strengths": ["Resilience", "Intuition"],
        "weaknesses": ["Obsession", "Control"],
        "advice": "Embrace change and let go of control.",
        "business": "Finance, research, therapy, occult practices.",
        "relationships": "Attracts partners with whom to experience deep transformation.",
        "purpose": "To undergo profound change and understand the mysteries of life."
    },
    9: {
        "name": "Ninth House",
        ...
        "traits": ["Philosophical", "Adventurous"],
        "strengths": ["Wisdom", "Open-mindedness"],
        "weaknesses": ["Dogmatism", "Restlessness"],
        "advice": "Seek knowledge, but stay grounded.",
        "business": "Education, law, travel, writing.",
        "relationships": "Seeks partners who share a love of learning and exploration.",
        "purpose": "To expand horizons and seek higher truths."
    },
    10: {
        ...
        "traits": ["Ambitious", "Responsible"],
        "strengths": ["Leadership", "Discipline"],
        "weaknesses": ["Workaholism", "Status-seeking"],
        "advice": "Focus on purpose, not just prestige.",
        "business": "Management, politics, entrepreneurship.",
        "relationships": "Values partners who support career goals.",
        "purpose": "To achieve success and leave a lasting legacy."
    },
    11: {
        "name": "Eleventh House",
        ...
        "traits": ["Social", "Idealistic"],
        "strengths": ["Networking", "Innovation"],
        "weaknesses": ["Detachment", "Unrealistic expectations"],
        "advice": "Balance idealism with practicality.",
        "business": "Technology, activism, community organizing.",
        "relationships": "Seeks partners who share social ideals.",
        "purpose": "To contribute to the community and envision a better future."
    },
    12: {
        "name": "Twelfth House",
        ...
        "traits": ["Intuitive", "Compassionate"],
        "strengths": ["Empathy", "Creativity"],
        "weaknesses": ["Isolation", "Self-deception"],
        "advice": "Connect with your intuition, but stay grounded in reality.",
        "business": "Healing arts, spirituality, creative pursuits.",
        "relationships": "Attracts partners with whom to explore the spiritual realm.",
        "purpose": "To understand the subconscious and connect with the unseen."
    }
}
...
def get_house_report_string(house_number: int) -> str:
    """Generates and returns a formatted string report for a given House number."""
    house_info = get_house_info(house_number)

    report_string = "=" * 60 + "\n"
    report_string += f"🌟 {house_info['name']} Report 🌟\n"
    report_string += "=" * 60 + "\n"
    report_string += f"🧾 Theme: {house_info['theme']}\n"
    report_string += f"📖 Meaning: {house_info['meaning']}\n"
    report_string += f"💡 Advice: {house_info['advice']}\n"
    report_string += "\n🔑 Core Traits: " + ', '.join(house_info['traits']) + "\n"
    report_string += "✅ Strengths: " + ', '.join(house_info['strengths']) + "\n"
    report_string += "⚠️ Weaknesses: " + ', '.join(house_info['weaknesses']) + "\n"
    report_string += "\n💼 Business Outlook:\n"
    report_string += f" - {house_info['business']}\n"
    report_string += "\n❤️ Relationships:\n"
    report_string += f" - {house_info['relationships']}\n"
    report_string += "\n🎯 Life Purpose:\n"
    report_string += f" - {house_info['purpose']}\n"
    report_string += "\n🪐 Planet Interpretations:\n"
    for planet, interpretation in house_info['planet_interpretations'].items():
        report_string += f"  - {planet}: {interpretation}\n"
    report_string += "=" * 60 + "\n"
